...
//product
    ...
    public function allProduct(Request $request){
        ...
        return \view('pages.pagination_product',\compact('products','category','brand'));
    }
    public function allProductotal(Request $request){
        if($request->ajax()){
        $count = $request->numberProduct;
    ...
    public function allProductfilter(Request $request){
        if($request->ajax()){
            $filter = $request->myRange;
            $products= Product::where('product_price',$filter)->get();
            $output = '';
            if ($products){
                foreach ($products as $key =>$product){
                    $output .= '
