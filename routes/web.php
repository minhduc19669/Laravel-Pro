...
Route::prefix('home')->group(function(){
    ...
    Route::get('product/show','PageController@allProductotal')->name('product.total');
    Route::get('product/filter/price','PageController@allProductfilter')->name('product.filter');
