            ...
            $.ajax({
                ...
                success: function (data) {
                    if ($.isEmptyObject(data.error)) {
                        let element = '<div class="sin-rattings">' + '<div class="star-author-all">' + '<div class="product-rating f-left">' + '<i class="ti-star 		 theme-color">' + '</i>' + '<i class="ti-star theme-color">' +
                            '</i>' +
