    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="mt-4">
                ...
                <form class="form-horizontal parsley-examples" action="{{route('role.update',$role->id)}}" method="post">
                    @csrf
                    <div class="form-group">
                        <label>Tên chức vụ(*):</label>
                    <input value="{{$role->role_name}}" autofocus type="text" name="role_name" class="form-control" placeholder="Enter a valid name">
                    </div>
                    <div class="form-group">
