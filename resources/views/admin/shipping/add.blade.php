                ...
                <div class="col-md-12">
                    <div class="form-row">
                        <div class="form-group col-md-5">
                            ...
                            <input  type="text" class="form-control" name="shipping_name" placeholder="Tên người gửi">
                        ...
                        <div class="form-group col-md-5">
                            ...
                            <input  type="text" class="form-control" name="shipping_name_receive" placeholder="Tên người nhận">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row col-md-12">
                            <div class="form-group col-md-5">
                                ...
                                <input   type="text" class="form-control" name="shipping_phone" placeholder="Số điện thoại người gửi">
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <input   type="text" class="form-control" name="shipping_phone_receive" placeholder="Số điện thoại người nhận">
                        ...
                        <div class="form-row col-md-12">
                            <div class="form-group col-md-5">
                                ...
                                <input  type="text" class="form-control" min="1000" name="shipping_address" placeholder="Địa chỉ người gửi">
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <input  type="text" class="form-control" min="1000" name="shipping_address_receive" placeholder="Địa chỉ người nhận">
                        ...
                        <div class="form-row">
                            <div class="form-row col-md-12">
                                <div class="form-group col-md-5">
                                    ...
                                    <input  type="email" class="form-control" name="shipping_email" placeholder="Chi tiết sản phẩm">
                                ...
                                <div class="form-group col-md-5">
                                    ...
                                    <textarea id="editor2" type="text" class="form-control" name="shipping_node" placeholder="Ghi chú"></textarea>
